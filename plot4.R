...
## Create and add Plot #1
with(dataset, plot(`Time`, `Global Active Power`, type = "l", xlab = "",
                   ylab = "Global Active Power"))

## Create and add Plot #2
with(dataset, plot(`Time`, `Voltage`, type = "l", xlab = "datetime",
                   ylab = "Voltage"))

## Create and add Plot #3
...
## Create and add Plot #4
with(dataset, plot(`Time`, `Global Reactive Power`, type = "l", 
